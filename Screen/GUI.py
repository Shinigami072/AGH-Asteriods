...
class StringC:
    def __init__(self,string,x,y,color=View.Renderer.WHITE,font="default",scale=12):
        self.color = color
        self.font=font
        self.string=string
        self.x=x
...
class Input:
    def __init__(self, string, x, y, width, height, font="default",color=View.Renderer.WHITE, id=0,
                 menuCount=1, scale=12,maxwidth=-1):
        self.string = StringC(string, x, y, View.Renderer.WHITE, scale=scale,font=font)
        self.string.x = x + 0.5
    ...
    def update(self, mousepos, mousebut):
        ...
        if (self.state == 0):
            self.string.color = View.Renderer.WHITE
        elif self.state ==2:
            self.string.color = (144,144,144)
        else:
            self.string.color = View.Renderer.BLACK
...
class Button:
    def __init__(self,string,x,y,width,height,function=None,argument=None,color=View.Renderer.WHITE,id=0,menuCount=1,scale=12):
        self.string=StringC(string,x,y,View.Renderer.WHITE,scale=scale)
        self.string.x = x+0.5
        self.string.y = y+height-self.string.height
